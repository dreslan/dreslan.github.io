...
I went to SUNY Albany to study Math and Physics, wanting to become a theoretical physicist. I was a poor student though - while I met my wife there, I didn't graduate. I had to start over at Hudson Valley Community College in upstate NY, but did well and finished with a BS in Physics at RPI.

## Career

I switched to software engineering and got a job as a QA Analyst at a small local company, then moved to a startup called Apprenda that was building a PaaS before that was really a thing - pre Docker, pre Kubernetes. I went from SDET to Jr Scala Dev there.
...
Now that I've thoroughly bored you about myself, check out the other parts of the site.
